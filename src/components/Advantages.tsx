...
const ADVANTAGES = [
  ...
  },
  {
    ...
    title: 'Повне страхування відповідальності',
    description: 'Кожне завантажене авто застраховане. Ви можете бути абсолютно спокійні за збереження фарби, дисків та бампера вашого авто.',
  },
  {
